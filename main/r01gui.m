...
% Frame Rate Panel and Text Box %
r01.gui.frame_rate_panel = uipanel(r01.gui.fig_main, 'Title', 'Frame Rate', 'Units', 'normalized', 'Scrollable', 'off');
r01.gui.frame_rate_panel.Position = [.5 .5 .05 .1];
...
% X and Y Direction
r01.gui.XY_panel = uipanel(r01.gui.fig_main, 'Title', 'XY Direction', 'Units', 'normalized', 'Scrollable', 'off');
r01.gui.XY_panel.Position = [.6 .5 .05 .1];

r01.gui.XY_button = uicontrol(r01.gui.XY_panel, ...
    "Style", "pushbutton", "Units", "normalized", ...
    "String", "Submit", ...
    "Callback", @(src, event) set_xy(src, event),...
    "Position", [.1 .2 .8 .3]);


r01.gui.XY_box = uicontrol(r01.gui.XY_panel, ...
    "Style", "edit", "Units", "normalized", ...
    "String", "", ...
    "Position", [.1 .6 .8 .3]);

% Force Plate Frame Rate Direction
r01.gui.FFr_panel = uipanel(r01.gui.fig_main, 'Title', 'Force Plate Frame Rate', 'Units', 'normalized', 'Scrollable', 'off');
r01.gui.FFr_panel.Position = [.7 .5 .05 .1];

r01.gui.FFr_button = uicontrol(r01.gui.FFr_panel, ...
    "Style", "pushbutton", "Units", "normalized", ...
    "String", "Submit", ...
    "Callback", @(src, event) set_ffr(src, event),...
    "Position", [.1 .2 .8 .3]);


r01.gui.FFr_box = uicontrol(r01.gui.FFr_panel, ...
    "Style", "edit", "Units", "normalized", ...
    "String", "", ...
    "Position", [.1 .6 .8 .3]);


% Trial Info Gait Check %
...
r01.gui.btn_gait_check = uicontrol(r01.gui.info_panel, ...
    ...
    'Callback', @(src, event) selection_routing(src, event, 'Gait Events', 0));

% Trial Info Gait Force Check %
...
r01.gui.btn_gait_force_check = uicontrol(r01.gui.info_panel, ...
    ...
    'Callback', @(src, event) selection_routing(src, event, 'Gait Events & Clean Force Strikes', 0));

% Trial Info R01  Check %
...
r01.gui.btn_r01_check = uicontrol(r01.gui.info_panel, ...
    ...
    'Callback', @(src, event) selection_routing(src, event, 'R01 Analysis', 0));

% Trial Info Obstacle Crossing  Check %
r01.gui.trial_panel_obs_crossing = uicontrol(r01.gui.info_panel, ...
    'Style', 'text', 'Units', 'normalized', ...
    'String', 'Obstacle Crossing Outcomes', 'HorizontalAlignment', 'left', 'FontSize', 12, ...
    'Position', [.1 .45 .75 .1]);

r01.gui.btn_obs_crossing = uicontrol(r01.gui.info_panel, ...
    'Style', 'pushbutton', 'Units', 'normalized', ...
    'String', '>', 'Position', [.87 .45 .08 .1], ...
    'Callback', @(src, event) selection_routing(src, event, 'Obstacle Crossing Outcomes', 0));

% Trial Info COP Check %
r01.gui.trial_panel_cop = uicontrol(r01.gui.info_panel, ...
    'Style', 'text', 'Units', 'normalized', ...
    'String', 'COP', 'HorizontalAlignment', 'left', 'FontSize', 12, ...
    'Position', [.1 .35 .75 .1]);

r01.gui.btn_cop = uicontrol(r01.gui.info_panel, ...
    'Style', 'pushbutton', 'Units', 'normalized', ...
    'String', '>', 'Position', [.87 .35 .08 .1], ...
    'Callback', @(src, event) selection_routing(src, event, 'COP', 0));
...
r01.gui.btn_test6 = uicontrol(r01.gui.info_panel, ...
    ...
    'Callback', @(src, event) selection_routing(src, event, 'ENTER CALLBACK HERE', 0));
