...
r01.gui.btn_r01_check = uicontrol(r01.gui.info_panel, ...
    ...
    'Callback', 'selection_routing("R01 Analysis", 100)');
...
% Button for Analyze %
r01.gui.process_button = uicontrol(r01.gui.process_area, "Style","pushbutton", "String", "Select", "Callback", 'process_callback(100)');
