...
if hs_foot== 1 % if left heelstrike
    disp = direction*(lheeAP(to) - lheeAP(hs))/1000; % in m, -20 to make sure foot is still on belt
    ...
    disp = direction*(rheeAP(to) - rheeAP(hs))/1000;
